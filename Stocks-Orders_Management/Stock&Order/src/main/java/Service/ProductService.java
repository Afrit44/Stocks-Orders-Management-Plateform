...
public class ProductService {
    ...
    public static void insertProduct(int productId, String name, int stock, Connection connection) throws  SQLException {

        // SQL statement for creating a new table
        String queryOrder = "INSERT INTO PRODUCT values("+productId+", '"+name+"',"+stock+"); ";
